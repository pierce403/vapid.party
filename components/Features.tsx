export default function Features() {
  const features = [
    ...
    },
    {
      ...
      title: 'User & Channel Targeting',
      description: 'Tag subscriptions with userId or channelId to send targeted notifications to specific audiences.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">
            ...
            <span className="glow-text"> push</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <div
              key={i}
              className="card hover:border-vapor-500/30 transition-colors group"
              style={{ animationDelay: `${i * 100}ms` }}
            >
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-vapor-500/20 to-vapor-600/20 flex items-center justify-center text-vapor-400 mb-4 group-hover:scale-110 transition-transform">
                {feature.icon}
              </div>
